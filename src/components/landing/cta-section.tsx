...
export function CTASection() {
  return (
    <section className="px-6 pb-24">
      <div className="mx-auto max-w-4xl rounded-2xl border border-border bg-gradient-to-br from-primary/12 via-background/90 to-accent/8 p-8 text-center shadow-lg sm:rounded-3xl sm:p-12 sm:backdrop-blur-sm">
