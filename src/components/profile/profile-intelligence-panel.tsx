  ...
  return (
    <ul className="flex flex-wrap gap-1.5">
      {items.map((s) => (
        <li
          key={s}
          className="rounded-md border border-border/60 bg-muted/25 px-2 py-0.5 text-xs font-medium text-foreground"
        >
          {s}
        </li>
      ))}
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Collapsible defaultOpen className="group/c0 sm:col-span-2">
            ...
            <CollapsibleContent className="overflow-hidden data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:animate-in data-[state=open]:fade-in-0">
              <div className="mt-2 space-y-3 rounded-xl border border-border/50 bg-background/25 p-4 sm:p-5">
                <div>
          ...
          <Collapsible className="group/c1 sm:col-span-2">
            ...
            <CollapsibleContent>
              <div className="mt-2 grid gap-3 rounded-xl border border-border/50 bg-background/25 p-4 sm:grid-cols-2 sm:p-5">
                <div>
          ...
          {(intelligence.missingSkillHints?.length ||
            ...
            <Collapsible className="group/c2 sm:col-span-2">
              ...
              <CollapsibleContent>
                <div className="mt-2 space-y-4 rounded-xl border border-border/50 bg-background/25 p-4 sm:p-5">
                  {intelligence.missingSkillHints?.length ? (
                    <div>
