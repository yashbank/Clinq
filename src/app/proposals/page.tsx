      ...
      <div className="flex min-h-screen bg-background gradient-mesh">
        ...
        <main className="flex flex-1 flex-col overflow-hidden">
          ...
          <div className="flex flex-1 flex-col overflow-hidden lg:flex-row">
            <div className="flex w-full shrink-0 flex-col gap-4 overflow-y-auto border-border p-3 pb-8 sm:p-5 lg:max-w-[420px] lg:border-r">
              <JobDescriptionInput />
            ...
            <div className="flex w-full shrink-0 flex-col gap-4 overflow-y-auto border-border p-3 pb-8 sm:p-5 lg:max-w-[340px] lg:border-l">
              <ProposalSettings />
              <div className="rounded-2xl border border-border bg-card/95 p-4 shadow-sm">
